...
static const ISP_IQParamTypeDef ISP_IQParamCacheInit_VD65G4 = {
    ...
    .AWBAlgo = {
        .enable = 1,
        .label = { "A", "TL84", "D65", "", "", },
        .referenceColorTemp = { 2856, 4000, 6500, 0, 0, },
        .ispGainR = { 100000000, 122000000, 172000000, 0, 0, },
        .ispGainG = { 106000000, 100000000, 100000000, 0, 0, },
        .ispGainB = { 311000000, 235000000, 150000000, 0, 0, },
        .coeff = {
